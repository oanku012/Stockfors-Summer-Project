...
class StockforsScene extends MapScene {
    ...
    BuildingsInitialize() {
        ...
        this.buildings.Hunajatalo = this.matter.add.sprite(1620, 820, 'buildingSheet', 'Hunajatalo', { shape: bodies.Hunajatalo }).setScale(0.4);
        ...
        this.buildings.Kaarihalli = this.matter.add.sprite(570, 590, 'buildingSheet', 'Kaarihalli', { shape: bodies.Kaarihalli }).setScale(0.6);
