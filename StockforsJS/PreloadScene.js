class PreloadScene extends Phaser.Scene {
    ...
    init(data){
        ...
        //String to indicate the data to get from the cache, usually it's 'assets'
    ...
    preload ()
    {
        ...
        this.loadAssets(this.cache.json.get(this.dataToLoad));
        //Backgroundimage
...
/*
function loadAssets (json, context)
    {
        Object.keys(json).forEach(function (group)
        {
            Object.keys(json[group]).forEach(function (key)
        ...
        // load dummy file to ensure loading gets completed
        context.load.image('dummy', 'Assets/images/dummy.jpg');
